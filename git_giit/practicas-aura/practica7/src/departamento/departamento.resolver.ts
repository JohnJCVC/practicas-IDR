...
export class DepartamentoResolver {
  ...
  createDepartamento(@Args('createDepartamentoInput') createDepartamentoInput: CreateDepartamentoInput) {
  ...
  @Mutation(() => Departamento)
  updateDepartamento(@Args('updateDepartamentoInput') updateDepartamentoInput: UpdateDepartamentoInput) {
